...
const Hero = () => {
  return (
        <motion.div className='w-full h-full flex flex-col items-center justify-center space-y-4 lg:my-12 '  variants={containerVariable} initial="before" animate="after">
