...
const Hero = () => {
  return (
    <div className='w-full h-full flex flex-col lg:flex-row items-center justify-center space-y-12'>
        <div className='w-full h-full flex flex-col items-center justify-center space-y-4 lg:items-start lg:px-12'>
                <h3 className='text-white text-sm font-roboto text-center tracking-wide cursor-default italic lg:text-base lg:text-left'>Creating your financial future from zero</h3>
                <h1 className='text-white text-5xl text-center font-roboto leading-snug tracking-widest cursor-default lg:text-left lg:text-7xl'>Digital Financial Wallet With Tracking System</h1>
                ...
                <div className='flex items-center justify-center px-4 lg:justify-start lg:px-0'>
