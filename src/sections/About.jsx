...
const About = () => {
  return (
    <section id='about' className='flex items-center justify-center w-full h-full flex-col-reverse lg:flex-row-reverse py-24 lg:px-12'>
        <div className='flex items-center justify-center w-full h-full flex-col space-y-8 lg:items-start'>
            <h1 className='text-white font-roboto text-3xl tracking-wider text-center px-4 lg:text-6xl lg:text-left'>What is Financial Wallet and Tracking?  </h1>
            ...
            <NavLink to='/explore' className='bg-white p-2 font-roboto text-sm rounded-md lg:p-4 lg:text-lg'>Explore Now</NavLink>
            </div>
        </div>
