...
const Learn = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center w-full space-y-12 lg:flex-row'>
                <ul className='flex flex-col items-center justify-center space-y-4 w-full px-12 lg:w-1/3'>
