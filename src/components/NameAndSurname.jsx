...
const NameAndSurname = () => {
  ...
  return (
    <motion.form className='flex items-center justify-center space-x-4 w-full' initial={{x: "100vw"}} animate={{x:0}} transition={{type:"tween", duration:0.4}}>
                <input className='text-black px-4 py-2 font-roboto tracking-wide w-[250px]' value={nameSurname} onChange={event => setNameSurname(event.target.value)} placeholder='Your name And Surname'></input>
